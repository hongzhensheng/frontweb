...
! function(t) {
	...
	o.fn = o.prototype = {}, o.fn.extend = t.extend, o.fn.extend({
		setup: function() {
			...
			return console.warn("Width or height size is null! - Skitter Slideshow"), !1;
			...
			if (this.settings.xml ? t.ajax({
				...
				i.box_skitter.find(".info_slide_thumb").width(h), i.box_skitter.css({
				...
				if (f.find(".image_number").each(function() {
					...
					var s = t.pageX,
						e = t.pageY,
						n = 0;
					s -= u, e -= m, novo_width = c - width_value, n = -(novo_width * s / width_value), n > 0 && (n = 0), -(c - d) > n && (n = -(c - d)), e > _ && f.css({
						left: n
					})
		...
		animationGlassCube: function() {
			...
			for (i = 0; i < n; i++) {
				...
				u.css({
					...
					left: _,
					top: c
				}, 1.9 * e, "easeOutQuad"), this.addBoxClone(u);
		...
		animationGlassBlock: function() {
			...
			for (i = 0; i < n; i++) {
				...
				f.css({
					...
					left: d,
					top: _
				}, 1.1 * e, "easeInOutQuad"), this.addBoxClone(f);
	...
	t.fn.css = function(i, e) {
		if (null === l && (l = "undefined" != typeof t.cssProps ? t.cssProps : "undefined" != typeof t.props ? t.props : {}), "undefined" == typeof l.transform && ("transform" == i || "object" == typeof i && "undefined" != typeof i.transform) && (l.transform = s(this.get(0))), "transform" != l.transform)
			if ("transform" == i) {
